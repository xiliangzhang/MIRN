...
def gen_movielen_data_set(data,seq_short_len=5,seq_prefer_len=50):
    ...
    print("test_set[0]:",len(test_set[0]))
    print(train_set[0])
    print(test_set[0])
    return train_set, test_set

def gen_movielen_model_input(train_set, user_profile, seq_short_len=5, seq_prefer_len=50):
